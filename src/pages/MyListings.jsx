...
const FRESHNESS_OPTIONS = [
    ...
    const handleEditSubmit = async (e) => {
        ...
        if (data.success) {
            setSubmitMsg('✅ Listing updated successfully!');
            fetchListings(token);
        ...
        setSubmitMsg('⚠ Failed to update listing. Please try again.');
        } finally {
        setSubmitting(false);
        }
    };
    ...
    return (
        ...
        <nav className="ml-nav">
            ...
            <span className="ml-nav-name">👤 {user.fullName}</span>
            <button className="ml-back-btn" onClick={() => navigate('/farmer-dashboard')}>
                ← Dashboard
            </button>
            <button className="ml-logout-btn" onClick={handleLogout}>Logout</button>
            </div>
        </nav>
        ...
        {showEditModal && (
            ...
            <div className="modal-box" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-grid">
                    ...
                    <input type="text" value={produceName}
                ...
                <div className="modal-footer">
                    <button type="button" className="ml-btn-secondary" onClick={handleCloseEdit}>
                    Cancel
                    </button>
        ...
        {showDeleteModal && deletingListing && (
            ...
            <div className="delete-modal-box" onClick={(e) => e.stopPropagation()}>
                ...
                <button className="ml-btn-secondary" onClick={handleCloseDelete}>
                    Cancel
                </button>
